const informacionLecturas = {
  "Sabia decisión": [
    ...
    },
    {
      ...
      insignia: "../img/lecturas/insignias/ElMisterioDelJarron.png",
    },
    {
      imagenLectura: "../img/lecturas/portadas/LaCasa1028.jpg",
      tituloLectura: "La casa 1028",
      insignia: "../img/lecturas/insignias/LaCasa1028.png",
    },
  ],
  "Sabia decisión2": [
    {
  ...
  "Suelta la respuesta": [
    {
      imagenLectura: "../img/lecturas/portadas/ElOsoDeAnteojos.jpg",
      tituloLectura: "El Oso de anteojos",
      insignia: "../img/lecturas/insignias/ElOsoDeAnteojos.png",
    },
    {
      imagenLectura: "../img/lecturas/portadas/LaLeyendaDeCantuña.png",
      tituloLectura: "La Leyenda de Cantuña",
      insignia: "../img/lecturas/insignias/LaLeyendaDeCantuña.png",
    },
    {
      imagenLectura: "../img/lecturas/portadas/ElGalloDeLaCatedral.png",
      tituloLectura: "El Gallo de la Catedral",
      insignia: "../img/lecturas/insignias/ElGalloDeLaCatedral.png",
    },
  ],
  ...
  "¿Qué pasó primero?": [
    {
      imagenLectura: "../img/lecturas/portadas/LaOllaDelPanecillo.jpg",
      tituloLectura: "La Olla del Panecillo",
      insignia: "../img/lecturas/insignias/LaOllaDelPanecillo.png",
    },
    {
      imagenLectura: "../img/lecturas/portadas/TioPumaYTioZorro.jpg",
      tituloLectura: "Tío Puma y Tío Zorro",
      insignia: "../img/lecturas/insignias/TioPumaYTioZorro.png",
    },
    {
      imagenLectura: "../img/lecturas/portadas/ElAncianoElNiñoYElBurro.jpg",
      tituloLectura: "El Anciano, El Niño y El Burro",
      insignia: "../img/lecturas/insignias/ElAncianoElNiñoYElBurro.png",
    },
  ],
  "¿Qué pasó primero?2": [
    {
  ...
  "¿Qué pasaría si...?": [
    ...
    },
    {
      ...
      insignia: "../img/lecturas/insignias/ElEspantapajarosSolidario.png",
    },
    {
      imagenLectura: "../img/lecturas/portadas/Los3Animalitos.jpg",
      tituloLectura: "Los tres animalitos",
      insignia: "../img/lecturas/insignias/Los3Animalitos.png",
    },
  ],
  "¿Qué pasaría si...?2": [
    {
...
export default informacionLecturas;
