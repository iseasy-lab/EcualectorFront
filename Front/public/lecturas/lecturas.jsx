...
const MostrarLectura = ({ tituloLectura }) => {
  switch (tituloLectura) {
    ...
    case "El misterio del jarrón":
      return (
        <p className="parrafos">
          ...
          percató de algo inusual: el hermoso jarrón de flores que solía decorar
          la entrada estaba roto.
          <br />
          ...
          situación con paciencia y sabiduría. Visitó cada mesa, recordándoles a
          sus alumnos la necesidad de asumir responsabilidades por sus acciones.
          <br />
          ...
          <br />
          Fue entonces cuando tres valientes estudiantes, Laura, Marcos y Adela,
          decidieron dar un paso al frente. Reconocieron haber tomado el jarrón
          para jugar y, sin querer, lo dejaron caer y romper. A pesar de haber
          tardado en admitir la verdad, estos jóvenes demostraron valentía al
          disculparse sinceramente y asumir su responsabilidad.
          <br />
          ...
          también fortalecieron los valores de responsabilidad y valentía en el
          aula.
        </p>
      );
    case "La casa 1028":
      return (
        <p className="parrafos">
          Había una vez una joven llamada Bella Aurora, una niña hermosa y única
          que vivía con sus padres en una ciudad donde las corridas de toros en
          la Plaza de la Independencia eran un evento común en aquellos tiempos.
          <br />
          ...
          Bella Aurora, se enfureció y saltó la barrera protectora. Se dirigió a
          la casa 1028 y, al llegar, derribó la puerta de entrada, asustando a
          los criados. Subió rápidamente hasta la habitación donde yacía Bella
          Aurora en su cama. Al ver al toro, ella intentó huir, pero estaba
          demasiado asustada y débil para hacerlo. El toro la embistió con
          dureza y, lamentablemente, la mató.
          <br />
          ...
          quien fue encontrada bañada en sangre y falleció esa misma tarde. Sus
          padres, devastados por la tragedia, la enterraron y, poco después,
          tomaron la dolorosa decisión de abandonar la ciudad.
          <br />
          El misterio rodeó a este toro, ya que nunca se supo de dónde provenía
          ni por qué atacó a la joven de manera tan feroz. Permaneció como un
    ...
    case "El Oso de anteojos":
      return (
        <p className="parrafos">
          ...
          América del Sur. En Ecuador, estos hermosos animales se encuentran en
          las regiones montañosas de los Andes y son una parte importante de la
          rica biodiversidad del país. Son animales grandes y peludos que pueden
          pesar hasta 200 kilogramos, ¡como cuatro niños juntos! Su pelaje es
          generalmente negro, pero las manchas de pelo blanco alrededor de sus
          ojos les dan un aspecto único.
          <br />
          Estos osos son muy buenos escaladores y pueden moverse con facilidad
          por las montañas y los árboles en las regiones andinas de Ecuador. Les
          encanta explorar su entorno en busca de frutas, hojas, insectos y
          hasta pequeños mamíferos. También son excelentes nadadores, lo que les
          permite cruzar ríos y lagos en busca de comida.
          <br />
          ...
          esencial cuidar de estos hermosos animales y proteger su hogar en los
          bosques andinos del Ecuador.
          <br />
          Los osos de anteojos son importantes para el equilibrio del ecosistema
          ecuatoriano, ya que ayudan a dispersar las semillas de las plantas que
          comen y contribuyen a la salud de los bosques. Son parte valiosa de la
          variedad de vida en Ecuador y un símbolo de la belleza natural del
          país.
        </p>
      );
    case "La Leyenda de Cantuña":
      return (
        <p className="parrafos">
          ...
          aceptó, y miles de diablillos comenzaron a trabajar tan pronto como la
          oscuridad envolvió la ciudad.
          <br />
          ...
          creyendo que la obra estaba completa, se acercó para reclamar su alma,
          Cantuña proclamó: "¡El trato ha sido incumplido!".
          <br />
          Lucifer, sorprendido al ver cómo un simple mortal lo había engañado,
          observó impotente cómo Cantuña salvaba su alma. El diablo, sintiéndose
          burlado, se retiró a los infiernos sin llevarse consigo su merecida
          recompensa.
        </p>
      );
    case "El Gallo de la Catedral":
      return (
        <p className="parrafos">
          ...
          Levantándose a las 6:00 a. m., desayunaba con un bistec asado, papas,
          huevos fritos y una taza de chocolate caliente. Posteriormente, se
          ...
          pudo bajar de la torre si el gallo era de fierro quedó sin respuesta,
    ...
    case "Los Otavalos":
      return (
        <p className="parrafos">
          ...
          región andina de Ecuador, es una expresión distintiva de su identidad
          cultural. Los otavaleños son conocidos por su rica herencia textil y
          la elaboración cuidadosa de sus prendas, que reflejan tanto su
          conexión con la naturaleza como su sentido de comunidad.
          <br />
          Para las mujeres otavaleñas, la vestimenta típica incluye una blusa
          llamada "anaco", ricamente bordada con diseños geométricos y florales,
          con colores y patrones que pueden tener significados culturales
          específicos. Además, llevan un chal llamado "fachalí" que cubre sus
          hombros y espalda, también decorado con bordados detallados.
          Complementan su atuendo con una falda llamada "enagua", de colores
          brillantes que complementan la paleta de colores de la blusa y el
          chal. Los accesorios, como joyería, collares y pulseras, son parte
          integral de su vestimenta, y suelen llevar el cabello largo y decorado
          con trenzas y cintas.
          <br />
          En el caso de los hombres otavaleños, la vestimenta incluye una camisa
          de manga larga, a menudo de colores oscuros y lisos. Complementan esto
          con un pantalón llamado "calzón", ajustado en la parte inferior y
          acompañado de un cinturón. El chaleco, conocido como "chumbi", es una
          parte esencial de su atuendo y presenta colores vibrantes y patrones
          geométricos. Los hombres también incorporan accesorios como sombreros
          y bufandas, y es común verlos con el cabello largo.
          <br />
          ...
          afiliación a grupos étnicos y la posición social de quienes la visten.
    ...
    case "La Olla del Panecillo":
      return (
        <p className="parrafos">
          ...
          una mujer llevaba a diario a su vaquita al Panecillo para alimentarla,
          ya que no disponía de un potrero propio. Un día, mientras recogía
          leña, dejó a la vaquita cerca de la olla, pero al regresar, se
          encontró con que había desaparecido. Llena de temor, comenzó a
          ...
          <br />
          Una vez recuperada del asombro, observó en un trono lujoso a una bella
          princesa que, al ver a la humilde señora, le preguntó con una sonrisa:
          <br />
          ...
          <br />
          Agradecida, la mujer salió del palacio con sus inesperados obsequios.
          Sin embargo, al llegar a la puerta, se llevó una gran sorpresa al ver
          a su vaca de regreso. Exclamó la mujer emocionada:
          <br />
          - ¡Ahí está mi vaca!
          <br />
          Así, la mujer y su vaquita regresaron a su hogar tras esa inolvidable
          aventura que quedó guardada como un secreto en la misteriosa olla del
          Panecillo.
        </p>
      );
    case "Tío Puma y Tío Zorro":
      return (
        <p className="parrafos">
          ...
          <br />
          - ¡Te encontré, Tío Zorro! No podrás escapar y serás mi almuerzo hoy.
          <br />
          Pero Tío Zorro no estaba dispuesto a ser la presa de Tío Puma, así que
          comenzó a maquinar un plan. Observó unas grandes piedras en lo alto de
          una colina y tuvo una idea. Dirigiéndose a Tío Puma, le dijo:
          <br />
          - Soy una presa pequeña, con poca carne. ¿Por qué conformarte conmigo
          pudiendo tener un banquete más sustancioso? En la colina hay un grupo
          de capibaras. Puedo subir rápidamente y llevarte una.
          <br />
          Confundido por la luz del sol, Tío Puma aceptó la oferta confiando en
          las palabras de Tío Zorro, a quien consideraba menos fuerte. Sin
    ...
    case "El Anciano, El Niño y El Burro":
      return (
        <p className="parrafos">
          ...
          niño bajo el sol.
          <br />
          Entonces, decidieron montar juntos al animal y así llegaron al cuarto
          pueblo. Un hombre se les acercó y les dijo:
          <br />
          - ¿Es suyo ese burrito?
          <br />
          ...
          burro, colocaron un palo entre ellas y lo cargaron sobre sus hombros.
          <br />
          ...
          cuerdas, terminó cayendo al río. Después de nadar y salir del agua, el
          burro se escapó por los caminos del campo.
          <br />
    ...
    case "La fuente de los talentos":
      return (
        <p className="parrafos">
          ...
          que lo descubrían dedicaban gran parte de su tiempo a perfeccionarlo y
          emplearlo en beneficio de los demás. Hasta que, un día, la fuente se
          secó y la comunidad empezó a inquietarse.
          <br />
          ...
          <br />
          La isla se sumió en la monotonía y el aburrimiento al no haber nuevos
          individuos talentosos. Todos actuaban de manera similar, cocinando
          igual, corriendo a la misma velocidad, o creando objetos semejantes.
          Cuando falleció el último habitante talentoso, la culpa invadió a
          todos, y aprendieron una lección vital:
          <br />
          - Debemos aceptar las diferencias de los demás sin juzgarlas, y ayudar
          a descubrir sus talentos en lugar de provocar envidia con los
          nuestros.
          <br />
    ...
    case "El espantapájaros solidario":
      return (
        <p className="parrafos">
          Érase una vez un agricultor muy avaro que vivía en un pueblo lejano de
          Ecuador. Su avaricia era tan extrema que, si un pájaro se atrevía a
          comer un grano de trigo del suelo, se enfurecía y pasaba el día entero
          vigilando su huerto para evitar que nadie lo tocara.
          <br />
          ...
          cabeza. Dos granos de maíz sirvieron de ojos, una zanahoria de nariz y
          una hilera de granos de trigo completaron su dentadura. Para darle un
          corazón, colocó el fruto más maduro de un granado en su pecho.
          <br />
          El espantapájaros quedó solo en el huerto, y pronto un gorrión
          necesitado se acercó buscando trigo. El muñeco de paja intentó cumplir
          su función, pero el pájaro se posó en un árbol y pidió comida para sus
          crías. Aunque inicialmente se negó, el espantapájaros ofreció sus
          dientes de trigo, dejándolo satisfecho, aunque sin dientes.
          <br />
          Días después, un conejo hambriento se acercó y deseó la zanahoria del
          espantapájaros. Con generosidad, el muñeco le ofreció su zanahoria,
          perdiendo así la capacidad de entonar una canción al no tener boca ni
          nariz.
          <br />
          Luego, un gallo madrugador llegó con un problema: quería prohibir a la
          gallina alimentar al agricultor con sus huevos. El espantapájaros,
          compasivo, le ofreció sus ojos de maíz para solucionar el dilema.
          <br />
          Más tarde, un antiguo trabajador despedido por el labrador recibió el
          vestido del espantapájaros cuando se encontraba en situación de
          vagabundo. También, un niño hambriento recibió la cabeza de calabaza
          del muñeco.
          <br />
          Cuando el agricultor descubrió el estado del espantapájaros, se enfadó
          y lo prendió fuego. Al caer al suelo su corazón de granada, el
          ...
          convirtió en un lugar acogedor donde todos acudían con la hermosa nota
          del calor humano.
        </p>
      );
    case "Los tres animalitos":
      return (
        <p className="parrafos">
          ...
          campo en busca de alimentos frescos y deliciosos.
          <br />
          ...
          <br />
          Antes de retirarse, colocó un banano en la entrada de la madriguera de
          cada uno de sus amigos.
          <br />
          Don Colibrí, explorando el campo, se topó con una exuberante flor de
          guayacán, una delicia para su pico delicado. Se alimentó de su néctar
          y recolectó dos flores adicionales para compartir con sus amigos.
          Antes de regresar a su nido, dejó sus regalos en la entrada de Don
          Tortuga y Don Tigrillo.
          <br />
          El tercer amigo, Don Tigrillo, descubrió un claro lleno de frutas
          tropicales, como los maracuyás. Se deleitó con una y apartó las otras
          dos, pensando en sus amigos. Dejó un maracuyá junto a la entrada de
          cada uno de sus amigos.
          <br />
          ...
          colocada. Con alegría, decidieron celebrar su amistad con un banquete
          en la selva ecuatoriana, donde compartieron las delicias culinarias
          autóctonas.
          <br />
